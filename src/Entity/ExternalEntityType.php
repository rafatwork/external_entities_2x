...
class ExternalEntityType extends ConfigEntityBase implements ExternalEntityTypeInterface {
  ...
  public function isAnnotatable() {
    return (bool) $this->getAnnotationField();
  }
  ...
  public function getAnnotationField() {
    if (!isset($this->annotation_field)) {
      if ($this->getAnnotationEntityTypeId() && $this->getAnnotationBundleId() && $this->getAnnotationFieldName()) {
